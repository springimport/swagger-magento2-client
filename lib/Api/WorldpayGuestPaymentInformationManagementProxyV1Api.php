...
class WorldpayGuestPaymentInformationManagementProxyV1Api
{
     ...
     *
     * @return WorldpayGuestPaymentInformationManagementProxyV1Api
     */
    ...
    public function worldpayGuestPaymentInformationManagementProxyV1SavePaymentInformationAndPlaceOrderPostWithHttpInfo($cartId, $body = null)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling worldpayGuestPaymentInformationManagementProxyV1SavePaymentInformationAndPlaceOrderPost');
        }
        // parse inputs
