...
class IntegrationAdminTokenServiceV1Api
{
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body140 $body body (optional)
     *
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body140 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'string';
        $request = $this->integrationAdminTokenServiceV1CreateAdminAccessTokenPostRequest($body);
     ...
     */
    public function integrationAdminTokenServiceV1CreateAdminAccessTokenPostAsync($body = null)
    {
        return $this->integrationAdminTokenServiceV1CreateAdminAccessTokenPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function integrationAdminTokenServiceV1CreateAdminAccessTokenPostAsyncWithHttpInfo($body = null)
    {
        $returnType = 'string';
        $request = $this->integrationAdminTokenServiceV1CreateAdminAccessTokenPostRequest($body);
     ...
     */
    protected function integrationAdminTokenServiceV1CreateAdminAccessTokenPostRequest($body = null)
    {
