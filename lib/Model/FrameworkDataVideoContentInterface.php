...
class FrameworkDataVideoContentInterface implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['videoProvider'] === null) {
            $invalid_properties[] = "'videoProvider' can't be null";
        }
        if ($this->container['videoUrl'] === null) {
            $invalid_properties[] = "'videoUrl' can't be null";
        }
        if ($this->container['videoTitle'] === null) {
            $invalid_properties[] = "'videoTitle' can't be null";
        }
        if ($this->container['videoDescription'] === null) {
            $invalid_properties[] = "'videoDescription' can't be null";
        }
        if ($this->container['videoMetadata'] === null) {
            $invalid_properties[] = "'videoMetadata' can't be null";
        }
