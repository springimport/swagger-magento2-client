...
class RequisitionListRequisitionListRepositoryV1Api
{
     ...
     *
     * @return RequisitionListRequisitionListRepositoryV1Api
     */
     ...
     * 
     *
     * @param \SpringImport\Swagger\Magento2\Client\Model\Body83 $body  (optional)
    ...
    public function requisitionListRequisitionListRepositoryV1SavePostWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\RequisitionListDataRequisitionListInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\RequisitionListDataRequisitionListInterface', $e->getResponseHeaders());
