...
class QuoteGuestPaymentMethodManagementV1Api
{
     ...
     *
     * @param  string $cartId The cart ID. (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body78 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
    ...
    {
        $returnType = 'int';
        $request = $this->quoteGuestPaymentMethodManagementV1SetPutRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestPaymentMethodManagementV1SetPutAsync($cartId, $body = null)
    {
        return $this->quoteGuestPaymentMethodManagementV1SetPutAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestPaymentMethodManagementV1SetPutAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = 'int';
        $request = $this->quoteGuestPaymentMethodManagementV1SetPutRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function quoteGuestPaymentMethodManagementV1SetPutRequest($cartId, $body = null)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException(
