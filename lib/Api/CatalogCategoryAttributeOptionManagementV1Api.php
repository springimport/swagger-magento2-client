...
class CatalogCategoryAttributeOptionManagementV1Api
{
    ...
    public function catalogCategoryAttributeOptionManagementV1GetItemsGetWithHttpInfo($attributeCode)
    {
        ...
        if ($attributeCode === null) {
            throw new \InvalidArgumentException('Missing the required parameter $attributeCode when calling catalogCategoryAttributeOptionManagementV1GetItemsGet');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeOptionInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeOptionInterface[]', $e->getResponseHeaders());
