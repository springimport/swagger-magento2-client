...
class Body1 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'attributeSet' => '\SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeSetInterface',
        'skeletonId' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['entityTypeCode'] === null) {
            $invalid_properties[] = "'entityTypeCode' can't be null";
        }
        if ($this->container['attributeSet'] === null) {
            $invalid_properties[] = "'attributeSet' can't be null";
        }
        if ($this->container['skeletonId'] === null) {
            $invalid_properties[] = "'skeletonId' can't be null";
        }
    ...
    /**
     * Sets attributeSet
     * @param \SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeSetInterface $attributeSet
     * @return $this
     */
