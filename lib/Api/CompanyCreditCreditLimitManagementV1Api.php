...
class CompanyCreditCreditLimitManagementV1Api
{
     ...
     *
     * @return CompanyCreditCreditLimitManagementV1Api
     */
    ...
    public function companyCreditCreditLimitManagementV1GetCreditByCompanyIdGetWithHttpInfo($companyId)
    {
        ...
        if ($companyId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $companyId when calling companyCreditCreditLimitManagementV1GetCreditByCompanyIdGet');
        }
        // parse inputs
