...
class CatalogProductRepositoryV1Api
{
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductInterface';
     ...
     */
    public function catalogProductRepositoryV1GetListGet($searchCriteria)
    {
        list($response) = $this->catalogProductRepositoryV1GetListGetWithHttpInfo($searchCriteria);
        return $response;
    }
     ...
     */
    public function catalogProductRepositoryV1GetListGetWithHttpInfo($searchCriteria)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductSearchResultsInterface';
        $request = $this->catalogProductRepositoryV1GetListGetRequest($searchCriteria);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductRepositoryV1GetListGetAsync($searchCriteria)
    {
        return $this->catalogProductRepositoryV1GetListGetAsyncWithHttpInfo($searchCriteria)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductRepositoryV1GetListGetAsyncWithHttpInfo($searchCriteria)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductSearchResultsInterface';
        $request = $this->catalogProductRepositoryV1GetListGetRequest($searchCriteria);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogProductRepositoryV1GetListGetRequest($searchCriteria)
    {
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body19 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductInterface
     ...
     *
     * @param  string $sku sku (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body20 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductInterface
     ...
     *
     * @param  string $sku (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body20 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductInterface, HTTP status code, HTTP response headers (array of strings)
