...
$apiInstance = new SpringImport\Swagger\Magento2\Client\Api\RmaTrackManagementV1Api(
...
try {
    $result = $apiInstance->rmaTrackManagementV1AddTrackPost($id, $body);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **body** | [**\SpringImport\Swagger\Magento2\Client\Model\Body176**](../Model/Body176.md)|  | [optional]
