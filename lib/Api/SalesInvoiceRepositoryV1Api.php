...
class SalesInvoiceRepositoryV1Api
{
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\SalesDataInvoiceInterface';
    ...
    {
        list($response) = $this->salesInvoiceRepositoryV1GetListGetWithHttpInfo($searchCriteria);
        return $response;
    }
    ...
    public function salesInvoiceRepositoryV1GetListGetWithHttpInfo($searchCriteria)
    {
        ...
        $request = $this->salesInvoiceRepositoryV1GetListGetRequest($searchCriteria);
    ...
    {
        return $this->salesInvoiceRepositoryV1GetListGetAsyncWithHttpInfo($searchCriteria)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body89 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\SalesDataInvoiceInterface
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\SalesDataInvoiceInterface';
        $request = $this->salesInvoiceRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesInvoiceRepositoryV1SavePostAsync($body = null)
    {
        return $this->salesInvoiceRepositoryV1SavePostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesInvoiceRepositoryV1SavePostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\SalesDataInvoiceInterface';
        $request = $this->salesInvoiceRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function salesInvoiceRepositoryV1SavePostRequest($body = null)
    {
