...
class SalesCreditmemoCommentRepositoryV1Api
{
    ...
    public function salesCreditmemoCommentRepositoryV1SavePostWithHttpInfo($id, $body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\SalesDataCreditmemoCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\SalesDataCreditmemoCommentInterface', $e->getResponseHeaders());
