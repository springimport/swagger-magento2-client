...
class CatalogProductAttributeRepositoryV1Api
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeSearchResultsInterface',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogProductAttributeRepositoryV1GetListGetRequest($searchCriteria)
    {
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body22 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface';
        $request = $this->catalogProductAttributeRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductAttributeRepositoryV1SavePostAsync($body = null)
    {
        return $this->catalogProductAttributeRepositoryV1SavePostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductAttributeRepositoryV1SavePostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface';
        $request = $this->catalogProductAttributeRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogProductAttributeRepositoryV1SavePostRequest($body = null)
    {
     ...
     *
     * @param  string $attributeCode attributeCode (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body21 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface
     ...
     *
     * @param  string $attributeCode (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body21 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface, HTTP status code, HTTP response headers (array of strings)
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface';
        $request = $this->catalogProductAttributeRepositoryV1SavePutRequest($attributeCode, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductAttributeRepositoryV1SavePutAsync($attributeCode, $body = null)
    {
        return $this->catalogProductAttributeRepositoryV1SavePutAsyncWithHttpInfo($attributeCode, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductAttributeRepositoryV1SavePutAsyncWithHttpInfo($attributeCode, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductAttributeInterface';
        $request = $this->catalogProductAttributeRepositoryV1SavePutRequest($attributeCode, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogProductAttributeRepositoryV1SavePutRequest($attributeCode, $body = null)
    {
        // verify the required parameter 'attributeCode' is set
        if ($attributeCode === null) {
            throw new \InvalidArgumentException(
