...
class DirectoryCurrencyInformationAcquirerV1Api
{
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\DirectoryDataCurrencyInformationInterface
     */
     ...
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\DirectoryDataCurrencyInformationInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function directoryCurrencyInformationAcquirerV1GetCurrencyInfoGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Swagger\Magento2\Client\Model\DirectoryDataCurrencyInformationInterface',
                '/V1/directory/currency'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\DirectoryDataCurrencyInformationInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\DirectoryDataCurrencyInformationInterface', $e->getResponseHeaders());
