...
class CheckoutGuestPaymentInformationManagementV1Api
{
     ...
     *
     * @param  string $cartId cartId (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body107 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     *
     * @param  string $cartId (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body107 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'int';
        $request = $this->checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostAsync($cartId, $body = null)
    {
        return $this->checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = 'int';
        $request = $this->checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostRequest($cartId, $body = null)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $cartId cartId (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body108 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     *
     * @param  string $cartId (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body108 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of int, HTTP status code, HTTP response headers (array of strings)
    ...
    {
        $returnType = 'int';
        $request = $this->checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostAsync($cartId, $body = null)
    {
        return $this->checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = 'int';
        $request = $this->checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostRequest($cartId, $body = null)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException(
