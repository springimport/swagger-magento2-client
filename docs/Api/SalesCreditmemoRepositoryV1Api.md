...
$apiInstance = new SpringImport\Swagger\Magento2\Client\Api\SalesCreditmemoRepositoryV1Api(
...
> \SpringImport\Swagger\Magento2\Client\Model\SalesDataCreditmemoSearchResultInterface salesCreditmemoRepositoryV1GetListGet($searchCriteria)
...
try {
    $result = $apiInstance->salesCreditmemoRepositoryV1GetListGet($searchCriteria);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->salesCreditmemoRepositoryV1SavePost($body);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SpringImport\Swagger\Magento2\Client\Model\Body94**](../Model/Body94.md)|  | [optional]
