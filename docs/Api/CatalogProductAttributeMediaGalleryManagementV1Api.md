...
$apiInstance = new SpringImport\Swagger\Magento2\Client\Api\CatalogProductAttributeMediaGalleryManagementV1Api(
...
------------- | ------------- | ------------- | -------------
 **sku** | **string**|  |
 **body** | [**\SpringImport\Swagger\Magento2\Client\Model\Body30**](../Model/Body30.md)|  | [optional]
...
try {
    $result = $apiInstance->catalogProductAttributeMediaGalleryManagementV1UpdatePut($sku, $entryId, $body);
    print_r($result);
} catch (Exception $e) {
 ...
 **sku** | **string**|  |
 **entryId** | **string**|  |
 **body** | [**\SpringImport\Swagger\Magento2\Client\Model\Body29**](../Model/Body29.md)|  | [optional]
