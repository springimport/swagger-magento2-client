...
class QuoteGuestShipmentEstimationV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body69 $body body (optional)
     *
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body69 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cartId, $body = null)
    {
        ...
        $request = $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostRequest($cartId, $body);
     ...
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostAsync($cartId, $body = null)
    {
        return $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\QuoteDataShippingMethodInterface[]';
        $request = $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostRequest($cartId, $body);
     ...
     */
    protected function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostRequest($cartId, $body = null)
    {
