...
class StoreStoreConfigManagerV1Api
{
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\StoreDataStoreConfigInterface[]
     */
     ...
     * @param string[] $storeCodes  (optional)
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\StoreDataStoreConfigInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeStoreConfigManagerV1GetStoreConfigsGetWithHttpInfo($storeCodes = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\StoreDataStoreConfigInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\StoreDataStoreConfigInterface[]', $e->getResponseHeaders());
