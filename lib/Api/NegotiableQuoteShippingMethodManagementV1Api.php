...
class NegotiableQuoteShippingMethodManagementV1Api
{
     ...
     *
     * @return NegotiableQuoteShippingMethodManagementV1Api
     */
    ...
    public function negotiableQuoteShippingMethodManagementV1EstimateByAddressIdPostWithHttpInfo($cartId, $body = null)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling negotiableQuoteShippingMethodManagementV1EstimateByAddressIdPost');
        }
        // parse inputs
