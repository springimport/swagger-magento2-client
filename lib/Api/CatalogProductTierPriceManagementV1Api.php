...
class CatalogProductTierPriceManagementV1Api
{
    ...
    public function catalogProductTierPriceManagementV1AddPostWithHttpInfo($sku, $customerGroupId, $price, $qty)
    {
        ...
        if ($customerGroupId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $customerGroupId when calling catalogProductTierPriceManagementV1AddPost');
        }
        ...
        if ($customerGroupId !== null) {
            $resourcePath = str_replace(
                "{" . "customerGroupId" . "}",
                $this->apiClient->getSerializer()->toPathValue($customerGroupId),
                $resourcePath
            );
        }
        // path params
    ...
    public function catalogProductTierPriceManagementV1GetListGetWithHttpInfo($sku, $customerGroupId)
    {
        ...
        // verify the required parameter 'customerGroupId' is set
        if ($customerGroupId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $customerGroupId when calling catalogProductTierPriceManagementV1GetListGet');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTierPriceInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTierPriceInterface[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\ErrorResponse', $e->getResponseHeaders());
    ...
    public function catalogProductTierPriceManagementV1RemoveDeleteWithHttpInfo($sku, $customerGroupId, $qty)
    {
        ...
        // verify the required parameter 'customerGroupId' is set
        if ($customerGroupId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $customerGroupId when calling catalogProductTierPriceManagementV1RemoveDelete');
        }
        // verify the required parameter 'qty' is set
        if ($qty === null) {
