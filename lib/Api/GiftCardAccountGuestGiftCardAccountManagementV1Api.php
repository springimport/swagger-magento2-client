...
class GiftCardAccountGuestGiftCardAccountManagementV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body165 $body body (optional)
     *
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body165 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'bool';
        $request = $this->giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPostRequest($cartId, $body);
     ...
     */
    public function giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPostAsync($cartId, $body = null)
    {
        return $this->giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPostAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPostAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = 'bool';
        $request = $this->giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPostRequest($cartId, $body);
     ...
     */
    protected function giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPostRequest($cartId, $body = null)
    {
