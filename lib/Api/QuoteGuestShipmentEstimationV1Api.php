...
class QuoteGuestShipmentEstimationV1Api
{
     ...
     * @param \SpringImport\Magento2SwaggerApi\Model\Body4 $body  (optional)
     * @throws \SpringImport\Magento2SwaggerApi\ApiException on non-2xx response
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataShippingMethodInterface[]
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost($cartId, $body = null)
    {
        list($response) = $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cartId, $body);
        return $response;
    }
     ...
     * @param \SpringImport\Magento2SwaggerApi\Model\Body4 $body  (optional)
     * @throws \SpringImport\Magento2SwaggerApi\ApiException on non-2xx response
     * @return array of \SpringImport\Magento2SwaggerApi\Model\QuoteDataShippingMethodInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cartId, $body = null)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Magento2SwaggerApi\Model\QuoteDataShippingMethodInterface[]',
                '/V1/guest-carts/{cartId}/estimate-shipping-methods'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Magento2SwaggerApi\Model\QuoteDataShippingMethodInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Magento2SwaggerApi\Model\QuoteDataShippingMethodInterface[]', $e->getResponseHeaders());
