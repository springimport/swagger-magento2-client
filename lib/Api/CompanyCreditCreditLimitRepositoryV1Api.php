...
class CompanyCreditCreditLimitRepositoryV1Api
{
     ...
     *
     * @return CompanyCreditCreditLimitRepositoryV1Api
     */
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface
     */
     ...
     * @param bool $reload [optional] (optional)
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function companyCreditCreditLimitRepositoryV1GetGetWithHttpInfo($creditId, $reload = null)
    {
        ...
        if ($creditId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $creditId when calling companyCreditCreditLimitRepositoryV1GetGet');
        }
        // parse inputs
        ...
        // query params
        if ($reload !== null) {
            $queryParams['reload'] = $this->apiClient->getSerializer()->toQueryValue($reload);
        }
        // path params
        if ($creditId !== null) {
            $resourcePath = str_replace(
                "{" . "creditId" . "}",
                $this->apiClient->getSerializer()->toPathValue($creditId),
                $resourcePath
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface',
                '/V1/companyCredits/{creditId}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface', $e->getResponseHeaders());
    ...
    public function companyCreditCreditLimitRepositoryV1GetListGetWithHttpInfo($searchCriteriaFilterGroupsFiltersField = null, $searchCriteriaFilterGroupsFiltersValue = null, $searchCriteriaFilterGroupsFiltersConditionType = null, $searchCriteriaSortOrdersField = null, $searchCriteriaSortOrdersDirection = null, $searchCriteriaPageSize = null, $searchCriteriaCurrentPage = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitSearchResultsInterface',
                '/V1/companyCredits/'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitSearchResultsInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitSearchResultsInterface', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\ErrorResponse', $e->getResponseHeaders());
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface
     */
    public function companyCreditCreditLimitRepositoryV1SavePut($id, $body = null)
    {
        list($response) = $this->companyCreditCreditLimitRepositoryV1SavePutWithHttpInfo($id, $body);
        return $response;
    }
     ...
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataCreditLimitInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function companyCreditCreditLimitRepositoryV1SavePutWithHttpInfo($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling companyCreditCreditLimitRepositoryV1SavePut');
        }
        // parse inputs
