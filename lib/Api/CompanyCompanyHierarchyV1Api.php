...
class CompanyCompanyHierarchyV1Api
{
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataHierarchyInterface[]';
     ...
     *
     * @param  int $id id (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body136 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function companyCompanyHierarchyV1MoveNodePutWithHttpInfo($id, $body = null)
    {
        ...
        $request = $this->companyCompanyHierarchyV1MoveNodePutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyCompanyHierarchyV1MoveNodePutAsync($id, $body = null)
    {
        return $this->companyCompanyHierarchyV1MoveNodePutAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyCompanyHierarchyV1MoveNodePutAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\ErrorResponse';
        $request = $this->companyCompanyHierarchyV1MoveNodePutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function companyCompanyHierarchyV1MoveNodePutRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
