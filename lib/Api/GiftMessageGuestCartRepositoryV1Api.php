...
class GiftMessageGuestCartRepositoryV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body172 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return bool
     ...
     *
     * @param  string $cartId The cart ID. (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body172 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'bool';
        $request = $this->giftMessageGuestCartRepositoryV1SavePostRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function giftMessageGuestCartRepositoryV1SavePostAsync($cartId, $body = null)
    {
        return $this->giftMessageGuestCartRepositoryV1SavePostAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function giftMessageGuestCartRepositoryV1SavePostAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = 'bool';
        $request = $this->giftMessageGuestCartRepositoryV1SavePostRequest($cartId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function giftMessageGuestCartRepositoryV1SavePostRequest($cartId, $body = null)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException(
