...
class CatalogProductRenderListV1Api
{
    ...
    public function catalogProductRenderListV1GetListGetWithHttpInfo($storeId, $currencyCode, $searchCriteriaFilterGroupsFiltersField = null, $searchCriteriaFilterGroupsFiltersValue = null, $searchCriteriaFilterGroupsFiltersConditionType = null, $searchCriteriaSortOrdersField = null, $searchCriteriaSortOrdersDirection = null, $searchCriteriaPageSize = null, $searchCriteriaCurrentPage = null)
    {
        ...
        if ($storeId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $storeId when calling catalogProductRenderListV1GetListGet');
        }
        // verify the required parameter 'currencyCode' is set
        if ($currencyCode === null) {
            throw new \InvalidArgumentException('Missing the required parameter $currencyCode when calling catalogProductRenderListV1GetListGet');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductRenderSearchResultsInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductRenderSearchResultsInterface', $e->getResponseHeaders());
