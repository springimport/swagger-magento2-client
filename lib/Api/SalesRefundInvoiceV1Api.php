...
class SalesRefundInvoiceV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body91 $body body (optional)
     *
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body91 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'int';
        $request = $this->salesRefundInvoiceV1ExecutePostRequest($invoiceId, $body);
     ...
     */
    public function salesRefundInvoiceV1ExecutePostAsync($invoiceId, $body = null)
    {
        return $this->salesRefundInvoiceV1ExecutePostAsyncWithHttpInfo($invoiceId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesRefundInvoiceV1ExecutePostAsyncWithHttpInfo($invoiceId, $body = null)
    {
        $returnType = 'int';
        $request = $this->salesRefundInvoiceV1ExecutePostRequest($invoiceId, $body);
     ...
     */
    protected function salesRefundInvoiceV1ExecutePostRequest($invoiceId, $body = null)
    {
