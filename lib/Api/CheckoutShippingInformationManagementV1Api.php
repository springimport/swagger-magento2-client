...
class CheckoutShippingInformationManagementV1Api
{
    ...
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost_0WithHttpInfo($cartId, $body = null)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling checkoutShippingInformationManagementV1SaveAddressInformationPost_0');
        }
        // parse inputs
