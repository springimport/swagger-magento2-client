...
class NegotiableQuoteShipmentEstimationV1Api
{
     ...
     *
     * @return NegotiableQuoteShipmentEstimationV1Api
     */
    ...
    public function negotiableQuoteShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cartId, $body = null)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling negotiableQuoteShipmentEstimationV1EstimateByExtendedAddressPost');
        }
        // parse inputs
