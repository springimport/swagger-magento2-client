 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Body153 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'quoteId' => 'int',
        'comment' => 'string',
        'files' => '\SpringImport\Swagger\Magento2\Client\Model\NegotiableQuoteDataAttachmentContentInterface[]'
    ];
    ...
    /**
     * Sets files
     * @param \SpringImport\Swagger\Magento2\Client\Model\NegotiableQuoteDataAttachmentContentInterface[] $files
     * @return $this
     */
