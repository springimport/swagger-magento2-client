# SpringImport\Swagger\Magento2\Client\SalesTransactionRepositoryV1Api
...
> \SpringImport\Swagger\Magento2\Client\Model\SalesDataTransactionInterface salesTransactionRepositoryV1GetGet($id)
...
$apiInstance = new SpringImport\Swagger\Magento2\Client\Api\SalesTransactionRepositoryV1Api(
...
[**\SpringImport\Swagger\Magento2\Client\Model\SalesDataTransactionInterface**](../Model/SalesDataTransactionInterface.md)
...
> \SpringImport\Swagger\Magento2\Client\Model\SalesDataTransactionSearchResultInterface salesTransactionRepositoryV1GetListGet($searchCriteria)
...
try {
    $result = $apiInstance->salesTransactionRepositoryV1GetListGet($searchCriteria);
    print_r($result);
} catch (Exception $e) {
...
[**\SpringImport\Swagger\Magento2\Client\Model\SalesDataTransactionSearchResultInterface**](../Model/SalesDataTransactionSearchResultInterface.md)
