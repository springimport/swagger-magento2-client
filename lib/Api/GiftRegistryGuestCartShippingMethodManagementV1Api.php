...
class GiftRegistryGuestCartShippingMethodManagementV1Api
{
    ...
    public function giftRegistryGuestCartShippingMethodManagementV1EstimateByRegistryIdPostWithHttpInfo($cartId, $body = null)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling giftRegistryGuestCartShippingMethodManagementV1EstimateByRegistryIdPost');
        }
        // parse inputs
