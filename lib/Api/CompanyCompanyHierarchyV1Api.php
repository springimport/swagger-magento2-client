...
class CompanyCompanyHierarchyV1Api
{
     ...
     *
     * @return CompanyCompanyHierarchyV1Api
     */
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\CompanyDataHierarchyInterface[]
     */
     ...
     * @param int $id  (required)
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CompanyDataHierarchyInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function companyCompanyHierarchyV1GetCompanyHierarchyGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling companyCompanyHierarchyV1GetCompanyHierarchyGet');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataHierarchyInterface[]',
                '/V1/hierarchy/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataHierarchyInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataHierarchyInterface[]', $e->getResponseHeaders());
     ...
     */
    public function companyCompanyHierarchyV1MoveNodePut($id, $body = null)
    {
        list($response) = $this->companyCompanyHierarchyV1MoveNodePutWithHttpInfo($id, $body);
        return $response;
    }
     ...
     */
    public function companyCompanyHierarchyV1MoveNodePutWithHttpInfo($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling companyCompanyHierarchyV1MoveNodePut');
        }
        // parse inputs
