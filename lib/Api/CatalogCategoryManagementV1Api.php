...
class CatalogCategoryManagementV1Api
{
    ...
    public function catalogCategoryManagementV1GetTreeGetWithHttpInfo($rootCategoryId = null, $depth = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataCategoryTreeInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataCategoryTreeInterface', $e->getResponseHeaders());
