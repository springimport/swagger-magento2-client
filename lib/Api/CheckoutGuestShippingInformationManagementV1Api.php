...
class CheckoutGuestShippingInformationManagementV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body101 $body body (optional)
     *
    ...
    public function checkoutGuestShippingInformationManagementV1SaveAddressInformationPostWithHttpInfo($cartId, $body = null)
    {
        ...
        $request = $this->checkoutGuestShippingInformationManagementV1SaveAddressInformationPostRequest($cartId, $body);
     ...
     */
    public function checkoutGuestShippingInformationManagementV1SaveAddressInformationPostAsync($cartId, $body = null)
    {
        return $this->checkoutGuestShippingInformationManagementV1SaveAddressInformationPostAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutGuestShippingInformationManagementV1SaveAddressInformationPostAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CheckoutDataPaymentDetailsInterface';
        $request = $this->checkoutGuestShippingInformationManagementV1SaveAddressInformationPostRequest($cartId, $body);
     ...
     */
    protected function checkoutGuestShippingInformationManagementV1SaveAddressInformationPostRequest($cartId, $body = null)
    {
