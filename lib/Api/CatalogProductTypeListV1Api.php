...
class CatalogProductTypeListV1Api
{
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTypeInterface[]
     */
     ...
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductTypeListV1GetProductTypesGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTypeInterface[]',
                '/V1/products/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductTypeInterface[]', $e->getResponseHeaders());
