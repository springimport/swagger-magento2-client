...
class CatalogProductAttributeOptionManagementV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body28 $body body (optional)
     *
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body28 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'bool';
        $request = $this->catalogProductAttributeOptionManagementV1AddPostRequest($attributeCode, $body);
     ...
     */
    public function catalogProductAttributeOptionManagementV1AddPostAsync($attributeCode, $body = null)
    {
        return $this->catalogProductAttributeOptionManagementV1AddPostAsyncWithHttpInfo($attributeCode, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductAttributeOptionManagementV1AddPostAsyncWithHttpInfo($attributeCode, $body = null)
    {
        $returnType = 'bool';
        $request = $this->catalogProductAttributeOptionManagementV1AddPostRequest($attributeCode, $body);
     ...
     */
    protected function catalogProductAttributeOptionManagementV1AddPostRequest($attributeCode, $body = null)
    {
     ...
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeOptionInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductAttributeOptionManagementV1GetItemsGetWithHttpInfo($attributeCode)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeOptionInterface[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SpringImport\Swagger\Magento2\Client\Model\EavDataAttributeOptionInterface[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
