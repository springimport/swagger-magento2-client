...
class SharedCatalogCompanyManagementV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body157 $body body (optional)
     *
    ...
    {
        $returnType = 'bool';
        $request = $this->sharedCatalogCompanyManagementV1AssignCompaniesPostRequest($sharedCatalogId, $body);
     ...
     */
    public function sharedCatalogCompanyManagementV1AssignCompaniesPostAsync($sharedCatalogId, $body = null)
    {
        return $this->sharedCatalogCompanyManagementV1AssignCompaniesPostAsyncWithHttpInfo($sharedCatalogId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sharedCatalogCompanyManagementV1AssignCompaniesPostAsyncWithHttpInfo($sharedCatalogId, $body = null)
    {
        $returnType = 'bool';
        $request = $this->sharedCatalogCompanyManagementV1AssignCompaniesPostRequest($sharedCatalogId, $body);
     ...
     */
    protected function sharedCatalogCompanyManagementV1AssignCompaniesPostRequest($sharedCatalogId, $body = null)
    {
     ...
     *
     * @param  int $sharedCatalogId sharedCatalogId (required)
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body158 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return bool
    ...
    {
        $returnType = 'bool';
        $request = $this->sharedCatalogCompanyManagementV1UnassignCompaniesPostRequest($sharedCatalogId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sharedCatalogCompanyManagementV1UnassignCompaniesPostAsync($sharedCatalogId, $body = null)
    {
        return $this->sharedCatalogCompanyManagementV1UnassignCompaniesPostAsyncWithHttpInfo($sharedCatalogId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sharedCatalogCompanyManagementV1UnassignCompaniesPostAsyncWithHttpInfo($sharedCatalogId, $body = null)
    {
        $returnType = 'bool';
        $request = $this->sharedCatalogCompanyManagementV1UnassignCompaniesPostRequest($sharedCatalogId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sharedCatalogCompanyManagementV1UnassignCompaniesPostRequest($sharedCatalogId, $body = null)
    {
        // verify the required parameter 'sharedCatalogId' is set
        if ($sharedCatalogId === null) {
            throw new \InvalidArgumentException(
