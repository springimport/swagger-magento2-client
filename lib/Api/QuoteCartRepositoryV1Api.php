...
class QuoteCartRepositoryV1Api
{
     ...
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\QuoteDataCartSearchResultsInterface
     */
    public function quoteCartRepositoryV1GetListGet($searchCriteria)
    {
        list($response) = $this->quoteCartRepositoryV1GetListGetWithHttpInfo($searchCriteria);
        return $response;
    }
     ...
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\QuoteDataCartSearchResultsInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function quoteCartRepositoryV1GetListGetWithHttpInfo($searchCriteria)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\QuoteDataCartSearchResultsInterface';
        $request = $this->quoteCartRepositoryV1GetListGetRequest($searchCriteria);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SpringImport\Swagger\Magento2\Client\Model\QuoteDataCartSearchResultsInterface',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteCartRepositoryV1GetListGetAsync($searchCriteria)
    {
        return $this->quoteCartRepositoryV1GetListGetAsyncWithHttpInfo($searchCriteria)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteCartRepositoryV1GetListGetAsyncWithHttpInfo($searchCriteria)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\QuoteDataCartSearchResultsInterface';
        $request = $this->quoteCartRepositoryV1GetListGetRequest($searchCriteria);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function quoteCartRepositoryV1GetListGetRequest($searchCriteria)
    {
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body60 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body60 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function quoteCartRepositoryV1SavePutWithHttpInfo($body = null)
    {
        ...
        $request = $this->quoteCartRepositoryV1SavePutRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteCartRepositoryV1SavePutAsync($body = null)
    {
        return $this->quoteCartRepositoryV1SavePutAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteCartRepositoryV1SavePutAsyncWithHttpInfo($body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\ErrorResponse';
        $request = $this->quoteCartRepositoryV1SavePutRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function quoteCartRepositoryV1SavePutRequest($body = null)
    {
