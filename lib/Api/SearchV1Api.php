...
class SearchV1Api
{
     ...
     * @return \SpringImport\Magento2SwaggerApi\Model\FrameworkSearchSearchResultInterface
     */
     ...
     * @param int $searchCriteriaCurrentPage Current page. (optional)
     * @throws \SpringImport\Magento2SwaggerApi\ApiException on non-2xx response
     * @return array of \SpringImport\Magento2SwaggerApi\Model\FrameworkSearchSearchResultInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchV1SearchGetWithHttpInfo($searchCriteriaRequestName = null, $searchCriteriaFilterGroupsFiltersField = null, $searchCriteriaFilterGroupsFiltersValue = null, $searchCriteriaFilterGroupsFiltersConditionType = null, $searchCriteriaSortOrdersField = null, $searchCriteriaSortOrdersDirection = null, $searchCriteriaPageSize = null, $searchCriteriaCurrentPage = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Magento2SwaggerApi\Model\FrameworkSearchSearchResultInterface',
                '/V1/search'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Magento2SwaggerApi\Model\FrameworkSearchSearchResultInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Magento2SwaggerApi\Model\FrameworkSearchSearchResultInterface', $e->getResponseHeaders());
