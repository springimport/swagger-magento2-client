...
class RmaRmaAttributesManagementV1Api
{
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CustomerDataAttributeMetadataInterface[]';
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\FrameworkMetadataObjectInterface[]';
