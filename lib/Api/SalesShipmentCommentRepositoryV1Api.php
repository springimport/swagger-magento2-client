...
class SalesShipmentCommentRepositoryV1Api
{
    ...
    public function salesShipmentCommentRepositoryV1SavePostWithHttpInfo($id, $body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\SalesDataShipmentCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\SalesDataShipmentCommentInterface', $e->getResponseHeaders());
