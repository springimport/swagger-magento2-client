...
class CheckoutShippingInformationManagementV1Api
{
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body102 $body body (optional)
     *
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body102 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body103 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CheckoutDataPaymentDetailsInterface
     */
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost_0($cartId, $body = null)
    {
        list($response) = $this->checkoutShippingInformationManagementV1SaveAddressInformationPost_0WithHttpInfo($cartId, $body);
        return $response;
    }
     ...
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CheckoutDataPaymentDetailsInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost_0WithHttpInfo($cartId, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CheckoutDataPaymentDetailsInterface';
        $request = $this->checkoutShippingInformationManagementV1SaveAddressInformationPost_0Request($cartId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost_0Async($cartId, $body = null)
    {
        return $this->checkoutShippingInformationManagementV1SaveAddressInformationPost_0AsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost_0AsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CheckoutDataPaymentDetailsInterface';
        $request = $this->checkoutShippingInformationManagementV1SaveAddressInformationPost_0Request($cartId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function checkoutShippingInformationManagementV1SaveAddressInformationPost_0Request($cartId, $body = null)
    {
