...
class CompanyRoleRepositoryV1Api
{
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface';
    ...
    {
        list($response) = $this->companyRoleRepositoryV1GetListGetWithHttpInfo($searchCriteria);
        return $response;
    }
    ...
    public function companyRoleRepositoryV1GetListGetWithHttpInfo($searchCriteria)
    {
        ...
        $request = $this->companyRoleRepositoryV1GetListGetRequest($searchCriteria);
    ...
    {
        return $this->companyRoleRepositoryV1GetListGetAsyncWithHttpInfo($searchCriteria)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body137 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface';
        $request = $this->companyRoleRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyRoleRepositoryV1SavePostAsync($body = null)
    {
        return $this->companyRoleRepositoryV1SavePostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyRoleRepositoryV1SavePostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface';
        $request = $this->companyRoleRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function companyRoleRepositoryV1SavePostRequest($body = null)
    {
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body138 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface';
        $request = $this->companyRoleRepositoryV1SavePutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyRoleRepositoryV1SavePutAsync($id, $body = null)
    {
        return $this->companyRoleRepositoryV1SavePutAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyRoleRepositoryV1SavePutAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CompanyDataRoleInterface';
        $request = $this->companyRoleRepositoryV1SavePutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function companyRoleRepositoryV1SavePutRequest($id, $body = null)
    {
