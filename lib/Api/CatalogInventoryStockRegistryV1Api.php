...
class CatalogInventoryStockRegistryV1Api
{
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogInventoryDataStockStatusCollectionInterface';
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogInventoryDataStockItemInterface';
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\CatalogInventoryDataStockStatusInterface';
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body54 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return int
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body54 $body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = 'int';
        $request = $this->catalogInventoryStockRegistryV1UpdateStockItemBySkuPutRequest($productSku, $itemId, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogInventoryStockRegistryV1UpdateStockItemBySkuPutAsync($productSku, $itemId, $body = null)
    {
        return $this->catalogInventoryStockRegistryV1UpdateStockItemBySkuPutAsyncWithHttpInfo($productSku, $itemId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogInventoryStockRegistryV1UpdateStockItemBySkuPutAsyncWithHttpInfo($productSku, $itemId, $body = null)
    {
        $returnType = 'int';
        $request = $this->catalogInventoryStockRegistryV1UpdateStockItemBySkuPutRequest($productSku, $itemId, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogInventoryStockRegistryV1UpdateStockItemBySkuPutRequest($productSku, $itemId, $body = null)
    {
        // verify the required parameter 'productSku' is set
        if ($productSku === null) {
            throw new \InvalidArgumentException(
