 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CatalogDataProductRenderInterface implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addToCartButton'] === null) {
            $invalid_properties[] = "'addToCartButton' can't be null";
        }
        if ($this->container['addToCompareButton'] === null) {
            $invalid_properties[] = "'addToCompareButton' can't be null";
        }
        if ($this->container['priceInfo'] === null) {
            $invalid_properties[] = "'priceInfo' can't be null";
        }
        ...
        if ($this->container['isSalable'] === null) {
            $invalid_properties[] = "'isSalable' can't be null";
        }
     ...
     * @param \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductRenderButtonInterface $addToCartButton
     * @return $this
     */
     ...
     * @param \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductRenderButtonInterface $addToCompareButton
     * @return $this
     */
    ...
    /**
     * Sets priceInfo
     * @param \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductRenderPriceInfoInterface $priceInfo
     * @return $this
     */
     ...
     * @param \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductRenderExtensionInterface $extensionAttributes
     * @return $this
     */
