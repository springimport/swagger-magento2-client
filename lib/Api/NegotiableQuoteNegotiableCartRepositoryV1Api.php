...
class NegotiableQuoteNegotiableCartRepositoryV1Api
{
     ...
     *
     * @return NegotiableQuoteNegotiableCartRepositoryV1Api
     */
    ...
    public function negotiableQuoteNegotiableCartRepositoryV1SavePutWithHttpInfo($quoteId, $body = null)
    {
        ...
        if ($quoteId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $quoteId when calling negotiableQuoteNegotiableCartRepositoryV1SavePut');
        }
        // parse inputs
