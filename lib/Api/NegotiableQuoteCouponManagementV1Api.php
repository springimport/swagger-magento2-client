...
class NegotiableQuoteCouponManagementV1Api
{
     ...
     *
     * @return NegotiableQuoteCouponManagementV1Api
     */
    ...
    public function negotiableQuoteCouponManagementV1RemoveDeleteWithHttpInfo($cartId)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling negotiableQuoteCouponManagementV1RemoveDelete');
        }
        // parse inputs
    ...
    public function negotiableQuoteCouponManagementV1SetPutWithHttpInfo($cartId, $couponCode)
    {
        // verify the required parameter 'cartId' is set
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling negotiableQuoteCouponManagementV1SetPut');
        }
        // verify the required parameter 'couponCode' is set
        if ($couponCode === null) {
            throw new \InvalidArgumentException('Missing the required parameter $couponCode when calling negotiableQuoteCouponManagementV1SetPut');
        }
        // parse inputs
