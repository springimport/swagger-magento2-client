...
class QuoteDataTotalsInterface implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'couponCode' => 'string',
        'itemsQty' => 'int',
        'items' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalsItemInterface[]',
        'totalSegments' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalSegmentInterface[]',
        'extensionAttributes' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalsExtensionInterface'
    ];
    ...
    /**
     * Gets items
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalsItemInterface[]
     */
    ...
    /**
     * Sets items
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalsItemInterface[] $items Totals by items
     * @return $this
     */
    ...
    /**
     * Gets totalSegments
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalSegmentInterface[]
     */
    ...
    /**
     * Sets totalSegments
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalSegmentInterface[] $totalSegments Dynamically calculated totals
     * @return $this
     */
     ...
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalsExtensionInterface
     */
     ...
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataTotalsExtensionInterface $extensionAttributes
     * @return $this
     */
