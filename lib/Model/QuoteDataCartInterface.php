...
class QuoteDataCartInterface implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'isActive' => 'bool',
        'isVirtual' => 'bool',
        'items' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataCartItemInterface[]',
        'itemsCount' => 'int',
        'itemsQty' => 'float',
        'customer' => '\SpringImport\Magento2SwaggerApi\Model\CustomerDataCustomerInterface',
        'billingAddress' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataAddressInterface',
        'reservedOrderId' => 'int',
        'origOrderId' => 'int',
        'currency' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataCurrencyInterface',
        'customerIsGuest' => 'bool',
        'customerNote' => 'string',
        'customerNoteNotify' => 'bool',
        'customerTaxClassId' => 'int',
        'storeId' => 'int',
        'extensionAttributes' => '\SpringImport\Magento2SwaggerApi\Model\QuoteDataCartExtensionInterface'
    ];
    ...
    /**
     * Sets items
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataCartItemInterface[] $items Array of items. Otherwise, null.
     * @return $this
     */
    ...
    /**
     * Sets customer
     * @param \SpringImport\Magento2SwaggerApi\Model\CustomerDataCustomerInterface $customer
     * @return $this
     */
    ...
    /**
     * Gets billingAddress
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataAddressInterface
     */
    ...
    /**
     * Sets billingAddress
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataAddressInterface $billingAddress
     * @return $this
     */
    ...
    /**
     * Gets currency
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataCurrencyInterface
     */
    ...
    /**
     * Sets currency
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataCurrencyInterface $currency
     * @return $this
     */
     ...
     * @return \SpringImport\Magento2SwaggerApi\Model\QuoteDataCartExtensionInterface
     */
     ...
     * @param \SpringImport\Magento2SwaggerApi\Model\QuoteDataCartExtensionInterface $extensionAttributes
     * @return $this
     */
