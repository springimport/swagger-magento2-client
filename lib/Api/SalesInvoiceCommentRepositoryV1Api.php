...
class SalesInvoiceCommentRepositoryV1Api
{
    ...
    public function salesInvoiceCommentRepositoryV1SavePostWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\SalesDataInvoiceCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\SalesDataInvoiceCommentInterface', $e->getResponseHeaders());
