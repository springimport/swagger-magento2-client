...
class CompanyCreditCreditHistoryManagementV1Api
{
     ...
     *
     * @return CompanyCreditCreditHistoryManagementV1Api
     */
    ...
    public function companyCreditCreditHistoryManagementV1GetListGetWithHttpInfo($searchCriteriaFilterGroupsFiltersField = null, $searchCriteriaFilterGroupsFiltersValue = null, $searchCriteriaFilterGroupsFiltersConditionType = null, $searchCriteriaSortOrdersField = null, $searchCriteriaSortOrdersDirection = null, $searchCriteriaPageSize = null, $searchCriteriaCurrentPage = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataHistorySearchResultsInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CompanyCreditDataHistorySearchResultsInterface', $e->getResponseHeaders());
    ...
    public function companyCreditCreditHistoryManagementV1UpdatePutWithHttpInfo($historyId, $body = null)
    {
        ...
        if ($historyId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $historyId when calling companyCreditCreditHistoryManagementV1UpdatePut');
        }
        // parse inputs
        ...
        if ($historyId !== null) {
            $resourcePath = str_replace(
                "{" . "historyId" . "}",
                $this->apiClient->getSerializer()->toPathValue($historyId),
                $resourcePath
            );
        }
        // default format to json
