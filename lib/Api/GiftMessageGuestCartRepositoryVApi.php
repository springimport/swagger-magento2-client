<?php
/**
 * GiftMessageGuestCartRepositoryVApi
 * PHP version 5
 *
 * @category Class
...
/**
 * GiftMessageGuestCartRepositoryVApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GiftMessageGuestCartRepositoryVApi
{
     ...
     *
     * @return GiftMessageGuestCartRepositoryVApi
     */
    ...
    public function giftMessageGuestCartRepositoryV1GetGetWithHttpInfo($cart_id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GiftMessageDataMessageInterface', $httpHeader), $statusCode, $httpHeader);
