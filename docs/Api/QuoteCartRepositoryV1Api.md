...
$apiInstance = new SpringImport\Swagger\Magento2\Client\Api\QuoteCartRepositoryV1Api(
...
> \SpringImport\Swagger\Magento2\Client\Model\QuoteDataCartSearchResultsInterface quoteCartRepositoryV1GetListGet($searchCriteria)
...
try {
    $result = $apiInstance->quoteCartRepositoryV1GetListGet($searchCriteria);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->quoteCartRepositoryV1SavePut($body);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SpringImport\Swagger\Magento2\Client\Model\Body60**](../Model/Body60.md)|  | [optional]
