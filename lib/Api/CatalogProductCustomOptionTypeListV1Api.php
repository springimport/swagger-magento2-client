...
class CatalogProductCustomOptionTypeListV1Api
{
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductCustomOptionTypeInterface[]
     */
     ...
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductCustomOptionTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductCustomOptionTypeListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductCustomOptionTypeInterface[]',
                '/V1/products/options/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductCustomOptionTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\CatalogDataProductCustomOptionTypeInterface[]', $e->getResponseHeaders());
