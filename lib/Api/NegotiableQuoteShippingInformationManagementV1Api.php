...
class NegotiableQuoteShippingInformationManagementV1Api
{
     ...
     *
     * @return NegotiableQuoteShippingInformationManagementV1Api
     */
    ...
    public function negotiableQuoteShippingInformationManagementV1SaveAddressInformationPostWithHttpInfo($cartId, $body = null)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling negotiableQuoteShippingInformationManagementV1SaveAddressInformationPost');
        }
        // parse inputs
