...
class CustomerDataAttributeMetadataInterface implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'inputFilter' => 'string',
        'storeLabel' => 'string',
        'validationRules' => '\SpringImport\Swagger\Magento2\Client\Model\CustomerDataValidationRuleInterface[]',
        'multilineCount' => 'int',
        'visible' => 'bool',
        'required' => 'bool',
        'dataModel' => 'string',
        'options' => '\SpringImport\Swagger\Magento2\Client\Model\CustomerDataOptionInterface[]',
     ...
     *
     * @return \SpringImport\Swagger\Magento2\Client\Model\CustomerDataValidationRuleInterface[]
     */
     ...
     *
     * @param \SpringImport\Swagger\Magento2\Client\Model\CustomerDataValidationRuleInterface[] $validationRules Validation rules.
     *
     * @return $this
     */
     ...
     * Gets options
     *
     * @return \SpringImport\Swagger\Magento2\Client\Model\CustomerDataOptionInterface[]
     */
     ...
     * Sets options
     *
     * @param \SpringImport\Swagger\Magento2\Client\Model\CustomerDataOptionInterface[] $options Options of the attribute (key => value pairs for select)
     *
     * @return $this
     */
