...
class NegotiableQuoteCartTotalRepositoryV1Api
{
     ...
     *
     * @return NegotiableQuoteCartTotalRepositoryV1Api
     */
    ...
    public function negotiableQuoteCartTotalRepositoryV1GetGetWithHttpInfo($cartId)
    {
        ...
        if ($cartId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cartId when calling negotiableQuoteCartTotalRepositoryV1GetGet');
        }
        // parse inputs
