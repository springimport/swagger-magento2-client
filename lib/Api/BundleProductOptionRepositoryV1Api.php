...
class BundleProductOptionRepositoryV1Api
{
    ...
    public function bundleProductOptionRepositoryV1DeleteByIdDeleteWithHttpInfo($sku, $optionId)
    {
        ...
        if ($optionId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $optionId when calling bundleProductOptionRepositoryV1DeleteByIdDelete');
        }
        // parse inputs
     ...
     * @param int $optionId  (required)
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\BundleDataOptionInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function bundleProductOptionRepositoryV1GetGetWithHttpInfo($sku, $optionId)
    {
        ...
        // verify the required parameter 'optionId' is set
        if ($optionId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $optionId when calling bundleProductOptionRepositoryV1GetGet');
        }
        // parse inputs
        $resourcePath = "/V1/bundle-products/{sku}/options/{optionId}";
        $httpBody = '';
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\BundleDataOptionInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\BundleDataOptionInterface', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\ErrorResponse', $e->getResponseHeaders());
