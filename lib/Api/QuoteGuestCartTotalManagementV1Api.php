...
class QuoteGuestCartTotalManagementV1Api
{
     ...
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body82 $body body (optional)
     *
    ...
    public function quoteGuestCartTotalManagementV1CollectTotalsPutWithHttpInfo($cartId, $body = null)
    {
        ...
        $request = $this->quoteGuestCartTotalManagementV1CollectTotalsPutRequest($cartId, $body);
     ...
     */
    public function quoteGuestCartTotalManagementV1CollectTotalsPutAsync($cartId, $body = null)
    {
        return $this->quoteGuestCartTotalManagementV1CollectTotalsPutAsyncWithHttpInfo($cartId, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestCartTotalManagementV1CollectTotalsPutAsyncWithHttpInfo($cartId, $body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\QuoteDataTotalsInterface';
        $request = $this->quoteGuestCartTotalManagementV1CollectTotalsPutRequest($cartId, $body);
     ...
     */
    protected function quoteGuestCartTotalManagementV1CollectTotalsPutRequest($cartId, $body = null)
    {
