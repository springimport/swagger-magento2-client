...
class StoreGroupRepositoryV1Api
{
     ...
     * @return \SpringImport\Swagger\Magento2\Client\Model\StoreDataGroupInterface[]
     */
     ...
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @return array of \SpringImport\Swagger\Magento2\Client\Model\StoreDataGroupInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeGroupRepositoryV1GetListGetWithHttpInfo()
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SpringImport\Swagger\Magento2\Client\Model\StoreDataGroupInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SpringImport\Swagger\Magento2\Client\Model\StoreDataGroupInterface[]', $e->getResponseHeaders());
