...
class SalesCreditmemoRepositoryV1Api
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function salesCreditmemoRepositoryV1GetListGetRequest($searchCriteria)
    {
     ...
     *
     * @param  \SpringImport\Swagger\Magento2\Client\Model\Body94 $body body (optional)
     *
     * @throws \SpringImport\Swagger\Magento2\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SpringImport\Swagger\Magento2\Client\Model\SalesDataCreditmemoInterface
    ...
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\SalesDataCreditmemoInterface';
        $request = $this->salesCreditmemoRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesCreditmemoRepositoryV1SavePostAsync($body = null)
    {
        return $this->salesCreditmemoRepositoryV1SavePostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function salesCreditmemoRepositoryV1SavePostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\SpringImport\Swagger\Magento2\Client\Model\SalesDataCreditmemoInterface';
        $request = $this->salesCreditmemoRepositoryV1SavePostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function salesCreditmemoRepositoryV1SavePostRequest($body = null)
    {
