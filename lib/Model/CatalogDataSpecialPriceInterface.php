 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CatalogDataSpecialPriceInterface implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['priceFrom'] === null) {
            $invalid_properties[] = "'priceFrom' can't be null";
        }
        if ($this->container['priceTo'] === null) {
            $invalid_properties[] = "'priceTo' can't be null";
        }
     ...
     * @param \SpringImport\Swagger\Magento2\Client\Model\CatalogDataSpecialPriceExtensionInterface $extensionAttributes
     * @return $this
     */
